...
export const metadata: Metadata = createPageMetadata({
  title: "Collections",
  description:
    "Explore the Signature Collection by Balloons by H — luxury handcrafted balloon bouquets in curated color stories, delivered across Beverly Hills and Los Angeles.",
  path: "/collections",
});
